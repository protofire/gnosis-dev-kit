...
const options = {
  ethereum: new Web3(new Web3.providers.HttpProvider('http://testrpc:8545')).currentProvider,
  ipfs: {
    host: 'ipfs',
    port: 5001,
    protocol: 'http'
...
const eventDescription = {
    title: 'Will Ethereum surpass Bitcoin in market cap in 2018?',
    description: 'Will Ethereum surpass Bitcoin in market cap in 2018?',
